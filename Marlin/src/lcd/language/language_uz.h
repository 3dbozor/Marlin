...
namespace Language_en {
  ...
  PROGMEM Language_Str LANGUAGE                            = _UxGT("Uzbek");

  PROGMEM Language_Str WELCOME_MSG                         = MACHINE_NAME _UxGT(" Tayyor.");
  PROGMEM Language_Str MSG_MARLIN                          = _UxGT("Marlin");
  PROGMEM Language_Str MSG_YES                             = _UxGT("HA");
  PROGMEM Language_Str MSG_NO                              = _UxGT("YO'Q");
  PROGMEM Language_Str MSG_BACK                            = _UxGT("Orqaga");
  PROGMEM Language_Str MSG_MEDIA_ABORTING                  = _UxGT("Qaytarish...");
  PROGMEM Language_Str MSG_MEDIA_INSERTED                  = _UxGT("SD-karta o'rnatildi");
  PROGMEM Language_Str MSG_MEDIA_REMOVED                   = _UxGT("SD-karta chiqarildi");
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("SD-kartani o'rnating");
